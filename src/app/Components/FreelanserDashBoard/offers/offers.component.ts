...
export class OffersComponent implements OnInit {
  ...
  constructor(
    ...
    public PPost: ProjectPostService
  ) {
  ...
  ngOnInit(): void {
    this.Freelancer.GetCurrentFreelancer().subscribe({
      next: (data: any) => {
        this.CurrenFreelancer = data.body.id;
        console.log(this.CurrenFreelancer);
        this.offerservice
          .GetAllByFreelancerId(this.CurrenFreelancer)
          .subscribe({
            next: (data) => {
              console.log(data);
              this.AllOffers = data;
      ...
      next: (data: any) => {
        ...
        this.offerservice.UpdateOffer(this.updatedoofer).subscribe({
          next: (data) => {
            ...
            this.PPost.CreateProjectPostForFreelancer(
              projectPost,
              this.updatedoofer.clientId
            ).subscribe({
              next: (data) => {
                console.log(data);
              },
