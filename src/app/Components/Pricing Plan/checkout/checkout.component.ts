...
export class CheckoutComponent implements OnInit {
  constructor(public translate: TranslateService,public PlanService:PlanService,public Route:ActivatedRoute,public Freelancer:FreelancerService,public router:Router) {
